...
@Entity
public class DetalleFichaAnalisis {
    ...
    public DetalleFichaAnalisis() {
    }

    public DetalleFichaAnalisis(Long id, Long idFicAna, Long idTipAna, String nomFicAna, String desFicAna, double pre, int can, double imp) {
        this.id = id;
